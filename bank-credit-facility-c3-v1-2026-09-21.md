...
2. expected loss on the flow-underwritten pool — assumed ⚠ 2.0–4.0%; with SC the 25% gate holds at the worst corner up to **4.8%** (floor 114 at a 4.8% loss line; 142.5 ÷ 114 − 1 = 25.0%); zero margin at 7.65%; at the pivot trigger of 5% the margin is 22.8%, BORDERLINE;
...
BINDING GATE — the loss rate on the flow-underwritten pool (identified at C1; printed at every challenge after)
  ...
  threshold:    4.8% — the 25% margin fails above it at the worst corner; 7.65% — the margin is zero
