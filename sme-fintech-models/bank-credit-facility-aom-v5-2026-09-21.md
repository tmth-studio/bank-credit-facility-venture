# Business bank credit facility line — activity and operating model (AOM), v5, at C5

**Venture:** the credit facility line of a large UK SME bank (Case B), Path C mode 3 — see `../bank-credit-facility-c5-v1-2026-09-21.md`. **v5 written at R5** (21 Sep 2026), runner-drafted under the propose-and-confirm rule. **v4**, **v3**, **v2** and **v1** are retained unchanged as the C4, C3, C2 and C1 records. **Update mode:** only the rows R5 adds or changes are new (marked *C5*, in bold); every other row is carried from v4 with its trace and its bold removed. R5 adds the Using stream's activation activities — default funding at authorisation, the funded-event notice and record, the funding queries it produces and the one-off drafting of the accepted term. The conventional Using activities (onboarding calls, help content, a support line for the first draws) are named in 3d as removed. The model file (`bank-credit-facility-aom-model-at-C5.yaml`) is a build item carried from C1; this document is the record until it exists.
...
floors:
  f.cell_min_people: 14 handlers + 1 lead (band 13–15) — reason: the C5 row adds ⚠ 70–475 hours a year plus ⚠ 0–425 hours of headroom for the first-year query peak to the 19,500 of v4; at the high corner (20,400 hours) and 1,400–1,600 productive hours the cell needs 12.8–14.6 handlers; 14 is the figure used (VA-91). Was 13 (band 12–14) at C4
```
...
| Model risk and credit oversight | owns the limit rule as a model; sets the risk appetite the rule expresses; reports to the board's risk committee; validates the back-test and reads each stage (C3); **reads the default-funded pool's loss against the drawn-ahead pool's at each stage (C5)** | HQ |
...
| **Cell total, recurring** | | | **q.cell_drawn_accounts = 100,000 (q.replica_accounts = 333,000 with a limit)** | | | **⚠ 17,905–20,400 — the figure used is the high corner, 20,400 (C5: 19,500 + 70–475 + ⚠ 0–425 headroom for the first-year query peak)** |
...
**Capacity figure used throughout (VA-91): ⚠ 20,400 exception hours per cell a year (C5 — the high corner of 17,905–20,400, with ⚠ 0–425 hours of headroom for the first-year funding-query peak); ⚠ 46,500 hours at scale (2.28 cells on ⚠ 228,000 drawn accounts).** One cell is ⚠ 14 handlers (band 13–15) at ⚠ 1,400–1,600 productive hours (19,600–22,400 hours against the 20,400) with a cell lead; the trainer is shared across cells. At the low corner of demand (17,905 hours) and the high corner of hours (1,600) the cell runs on 12 handlers with 1,295 hours of slack; 13 is the band floor because the headroom is held. At the high corner of demand and the low corner of hours (1,400) it needs 15. At scale: ⚠ 2.28 cells, ⚠ 32 handlers and 3 leads, ⚠ 36 people with the shared trainer. Every calculation in the C5 record uses 20,400 and 14.
...
| exception cells (from 3b; counted in the PVC layer, not here) | money · information · product | **36** | **2.05–2.7** | q.drawn_accounts — **C5: 14 handlers per cell (band 13–15), 2.28 cells; 32 handlers ⚠ £50–65k, 3 leads ⚠ £70–90k, trainer ⚠ £20–30k, tooling ⚠ £0.23–0.34m** |
| **All people in the form** | | **⚠ 84** | **⚠ 9.35–15.65** | ≈ ⚠ 0.16–0.46% of the drawn book, stated for scale only — no cost line is derived from it |
...
**Conventional additions used against the ⚠ £8 cap (RD-030):** R4 ⚠ 0.03–0.20; R5 ⚠ 0.02–0.06; cumulative through R5 ⚠ 0.05–0.26; remaining at the high corner ⚠ 7.74.
...
| fixed cost a year | **£0.9–1.18m (14 handlers ⚠ £50–65k loaded; lead ⚠ £70–90k; trainer share ⚠ £20–30k; tooling and premises ⚠ £0.1–0.15m) — C5; was £0.85–1.12m at 13 handlers** |
...
| PVC — computing and payments | **2.02–5.09** | 3a, rounded up; the saving statement adds ⚠ £0.003; the limit history adds ⚠ 0.01–0.07 (C4); **the funded-event notice adds ⚠ 0.00–0.02 (C5); the funded event itself adds nothing** |
| PVC — exceptions and write-off handling | **3.00–8.13** | 3b: ⚠ £2.05–2.7m across 2.28 cells ÷ £3.4–5.7bn = £0.36–0.79, plus write-off administration and legal ⚠ £3–7; the limit-query handlers add ⚠ 0.00–0.09 (C4); **the funding-query handlers add ⚠ 0.00–0.04 (C5)** |
| **PVC** | **40.02–83.22** | **C5: +0.01–0.06 on C4's 40.01–83.16** |
| RC | 2.02–5.04 | 3c: ⚠ £7.3–12.95m ÷ £3.4–5.7bn = £1.28–3.81, carried at the C1 band plus the conduct reviewer, ⚠ 0.02–0.04 (C4); **unchanged at C5** |
| SC | 0–1 | 3e: one-off ⚠ £0.64–12.1m (back-test and validation, migration, stage readings, the overlay's carrying cost) **plus the term drafting ⚠ £15–30k (C5)** ÷ 5 years ÷ £3.4–5.7bn = £0.02–0.71, rounded up to 0–1. The 5-year period is the runner's call: the MLR retention period and the path's ⚠ 27–42 months both sit inside it |
...
| **IC** | **12–17** | rounded |
| **Cost floor at C5 (PVC + RC + SC + IC)** | **54.04–106.26** | **C5 adds ⚠ 0.02–0.06 per £1,000 to the 54.03–106.20 of C4; carried at two decimals so the addition is visible against the ⚠ £8 cap** |
